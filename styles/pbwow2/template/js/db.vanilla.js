...
var Icon = {
	...
	setTexture: function (d, c, b) {
		...
		if (b.indexOf("?") != -1) {
			...
			a.backgroundImage = "url(http://db.vanillagaming.org/" + Icon.sizes[c] + "/" + b.toLowerCase() + ".jpg)"
		}
...
function () {
	...
	_link.href = "http://db.vanillagaming.org/templates/wowhead/css/power.css";
	_script.setAttribute("src","http://db.vanillagaming.org/templates/wowhead/js/locale_enus.js");
