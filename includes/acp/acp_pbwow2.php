		...
		*/
		...
		if($mode == 'overview') {
			$template->assign_vars(array(
				...
				'S_CPF_PBDCLASS'			=> (isset($cpflist['pbdclass']) && $cpflist['pbguild']['pbdclass'] == 0) ? true : false,
				'S_CPF_PBDGENDER'			=> (isset($cpflist['pbdgender']) && $cpflist['pbguild']['pbdgender'] == 0) ? true : false,
				'S_CPF_PBDFOLLOWER'			=> (isset($cpflist['pbdfollower']) && $cpflist['pbguild']['pbdfollower'] == 0) ? true : false,
