<?php if (!defined('IN_PHPBB')) exit; if ($this->_rootref['ADS_BOTTOM_CODE'] && ! $this->_rootref['S_INDEX_PAGE'] && ! $this->_rootref['S_IS_BOT']) {  ?>

	<div class="advertisement bottom"><?php echo (isset($this->_rootref['ADS_BOTTOM_CODE'])) ? $this->_rootref['ADS_BOTTOM_CODE'] : ''; ?></div>
	<?php } ?>
	...
	<div id="page-footer">
		<div class="navbar">
			<div class="inner">
				...
				<?php if ($this->_rootref['S_QUICK_STYLE_OPTIONS'] && ! $this->_rootref['TOPBAR_CODE']) {  $this->_tpl_include('prime_quick_style.html'); } ?>

			</div>
		</div>
		<div class="copyright"><?php echo (isset($this->_rootref['CREDIT_LINE'])) ? $this->_rootref['CREDIT_LINE'] : ''; ?><!-- Please don't remove. phpBB and PBWoW 2 are offered to you for free. --><?php if ($this->_rootref['TRANSLATION_INFO']) {  ?><br /><?php echo (isset($this->_rootref['TRANSLATION_INFO'])) ? $this->_rootref['TRANSLATION_INFO'] : ''; } if ($this->_rootref['DEBUG_OUTPUT']) {  ?><br /><?php echo (isset($this->_rootref['DEBUG_OUTPUT'])) ? $this->_rootref['DEBUG_OUTPUT'] : ''; } if ($this->_rootref['U_ACP']) {  ?><br /><strong><a href="<?php echo (isset($this->_rootref['U_ACP'])) ? $this->_rootref['U_ACP'] : ''; ?>"><?php echo ((isset($this->_rootref['L_ACP'])) ? $this->_rootref['L_ACP'] : ((isset($user->lang['ACP'])) ? $user->lang['ACP'] : '{ ACP }')); ?></a></strong><?php } ?>
...
</div> <!-- wrapper --><?php $this->_tpl_include('scripts_footer.html'); ?>
