<?php if (!defined('IN_PHPBB')) exit; if ($this->_rootref['S_DISPLAY_JUMPBOX']) {  ?>
	...
	<form method="post" id="jumpbox" action="<?php echo (isset($this->_rootref['S_JUMPBOX_ACTION'])) ? $this->_rootref['S_JUMPBOX_ACTION'] : ''; ?>" onsubmit="if(this.f.value == -1){return false;}">
