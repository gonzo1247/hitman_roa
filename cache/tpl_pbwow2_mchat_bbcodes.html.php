<?php if (!defined('IN_PHPBB')) exit; ?><div id="mChatBBCodes" style="padding: 5px; display: none;">
				<fieldset class="fields1">
					...
					// ]]>
						...
						<?php $this->_tpl_include('mchat_color.html'); if ($this->_rootref['S_MCHAT_BBCODE_B']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_I']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_U']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_QUOTE']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_CODE']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_LIST']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_LIST'] || $this->_rootref['S_MCHAT_LIST']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_IMG']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_URL']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_FLASH']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_SIZE']) {  ?>
						...
						<?php } if ($this->_rootref['S_MCHAT_BBCODE_COLOR']) {  ?>
