...
<?php if ($this->_rootref['S_EDIT_FORUM']) {  ?>
	...
	<h1><?php echo ((isset($this->_rootref['L_TITLE'])) ? $this->_rootref['L_TITLE'] : ((isset($user->lang['TITLE'])) ? $user->lang['TITLE'] : '{ TITLE }')); ?> <?php if ($this->_rootref['FORUM_NAME']) {  ?>:: <?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; } ?></h1>
	...
	<dl>
		...
		<dd><input type="password" id="forum_password" name="forum_password" value="<?php if ($this->_rootref['S_FORUM_PASSWORD_SET']) {  ?>&#x20;&#x20;&#x20;&#x20;&#x20;&#x20;<?php } ?>" autocomplete="off" /></dd>
	</dl>
	<dl>
		...
		<dd><input type="password" id="forum_password_confirm" name="forum_password_confirm" value="<?php if ($this->_rootref['S_FORUM_PASSWORD_SET']) {  ?>&#x20;&#x20;&#x20;&#x20;&#x20;&#x20;<?php } ?>" autocomplete="off" /></dd>
	</dl>
	...
	<div id="forum_cat_options">
		...
		<dl>
			...
			<dd><label><input type="radio" class="radio" name="display_active" value="1"<?php if ($this->_rootref['S_ENABLE_ACTIVE_TOPICS']) {  ?> id="display_active" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="display_active" value="0"<?php if (! $this->_rootref['S_ENABLE_ACTIVE_TOPICS']) {  ?> id="display_active" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		</fieldset>
	</div>
	...
	<div id="forum_post_options">
		...
		<dl>
			<dt><label for="enable_quick_reply"><?php echo ((isset($this->_rootref['L_ENABLE_QUICK_REPLY'])) ? $this->_rootref['L_ENABLE_QUICK_REPLY'] : ((isset($user->lang['ENABLE_QUICK_REPLY'])) ? $user->lang['ENABLE_QUICK_REPLY'] : '{ ENABLE_QUICK_REPLY }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_ENABLE_QUICK_REPLY_EXPLAIN'])) ? $this->_rootref['L_ENABLE_QUICK_REPLY_EXPLAIN'] : ((isset($user->lang['ENABLE_QUICK_REPLY_EXPLAIN'])) ? $user->lang['ENABLE_QUICK_REPLY_EXPLAIN'] : '{ ENABLE_QUICK_REPLY_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="enable_quick_reply" value="1"<?php if ($this->_rootref['S_ENABLE_QUICK_REPLY']) {  ?> id="enable_quick_reply" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="enable_quick_reply" value="0"<?php if (! $this->_rootref['S_ENABLE_QUICK_REPLY']) {  ?> id="enable_quick_reply" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		<dl>
		...
		<dl>
			<dt><label for="forum_recent_topics"><?php echo ((isset($this->_rootref['L_RECENT_TOPICS_LIST'])) ? $this->_rootref['L_RECENT_TOPICS_LIST'] : ((isset($user->lang['RECENT_TOPICS_LIST'])) ? $user->lang['RECENT_TOPICS_LIST'] : '{ RECENT_TOPICS_LIST }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_RECENT_TOPICS_LIST_EXPLAIN'])) ? $this->_rootref['L_RECENT_TOPICS_LIST_EXPLAIN'] : ((isset($user->lang['RECENT_TOPICS_LIST_EXPLAIN'])) ? $user->lang['RECENT_TOPICS_LIST_EXPLAIN'] : '{ RECENT_TOPICS_LIST_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="forum_recent_topics" value="1"<?php if ($this->_rootref['RECENT_TOPICS']) {  ?> id="forum_recent_topics" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="forum_recent_topics" value="0"<?php if (! $this->_rootref['RECENT_TOPICS']) {  ?> id="forum_recent_topics" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		</fieldset>
