...
<div class="panel bg1<?php if ($this->_rootref['S_ONLINE']) {  ?> online<?php } if ($this->_rootref['USER_SPECIAL_STYLING']) {  ?> <?php echo (isset($this->_rootref['USER_SPECIAL_STYLING'])) ? $this->_rootref['USER_SPECIAL_STYLING'] : ''; } ?>">
	<div class="inner"><span class="corners-top"><span></span></span>


	<div class="postprofile<?php if ($this->_rootref['S_ONLINE']) {  ?> online<?php } ?>">
		<div class="wow-profile">
		<?php if ($this->_rootref['AVATAR_SRC'] || $this->_rootref['S_PROFILE_PBAVATAR'] || $this->_rootref['S_PROFILE_PBBNETAVATAR']) {  if ($this->_rootref['AVATAR_SRC']) {  ?>

			<div class="game-avatar" style="background-image: url('<?php echo (isset($this->_rootref['AVATAR_SRC'])) ? $this->_rootref['AVATAR_SRC'] : ''; ?>');">
			<?php } else if ($this->_rootref['S_PROFILE_PBBNETAVATAR']) {  ?>

			<div class="game-avatar" style="background-image: url('<?php echo (isset($this->_rootref['PROFILE_PBBNETAVATAR_VALUEID'])) ? $this->_rootref['PROFILE_PBBNETAVATAR_VALUEID'] : ''; ?>');">
			<?php } else { ?>

			<div class="game-avatar" style="background-image: url('<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/portraits/<?php echo (isset($this->_rootref['PROFILE_PBAVATAR_VALUE'])) ? $this->_rootref['PROFILE_PBAVATAR_VALUE'] : ''; ?>');">
			<?php } ?>

				<div class="game-avatar-frame">
					<div class="game-rank-icon">
						<?php if ($this->_rootref['RANK_IMG'] && ( ( $this->_rootref['POSTS_RANK_TITLE'] != $this->_rootref['RANK_TITLE'] ) || ( ! $this->_rootref['S_PROFILE_PBRACE'] && ! $this->_rootref['S_PROFILE_PBDCLASS'] && ! $this->_rootref['S_PROFILE_PBWSRACE'] ) )) {  ?>

						<?php echo (isset($this->_rootref['RANK_IMG'])) ? $this->_rootref['RANK_IMG'] : ''; ?>

						<?php } else if ($this->_rootref['S_PROFILE_PBLEVEL'] && $this->_rootref['PROFILE_PBLEVEL_VALUE'] != 0) {  ?>

						<b><small><?php echo (isset($this->_rootref['PROFILE_PBLEVEL_VALUE'])) ? $this->_rootref['PROFILE_PBLEVEL_VALUE'] : ''; ?></small></b>
						<?php } else { ?>
					...
					<?php if ($this->_rootref['S_PROFILE_PBRACE'] || $this->_rootref['S_PROFILE_PBDCLASS'] || $this->_rootref['S_PROFILE_PBWSCLASS']) {  ?>

					<div class="game-icons-frame">

						<?php if ($this->_rootref['PROFILE_PBRACE_VALUEID']) {  ?>

						<div class="game-icons-a wow-<?php echo (isset($this->_rootref['PROFILE_PBRACE_VALUEID'])) ? $this->_rootref['PROFILE_PBRACE_VALUEID'] : ''; if ($this->_rootref['S_PROFILE_PBGENDER'] && $this->_rootref['PROFILE_PBGENDER_VALUEID'] > (1)) {  ?> female<?php } ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" title="<?php echo (isset($this->_rootref['PROFILE_PBRACE_VALUE'])) ? $this->_rootref['PROFILE_PBRACE_VALUE'] : ''; ?>" alt="<?php echo (isset($this->_rootref['PROFILE_PBRACE_VALUE'])) ? $this->_rootref['PROFILE_PBRACE_VALUE'] : ''; ?>" /></div>
						<?php } else if ($this->_rootref['PROFILE_PBDCLASS_VALUEID']) {  ?>

						<div class="game-icons-a diablo-<?php echo (isset($this->_rootref['PROFILE_PBDCLASS_VALUEID'])) ? $this->_rootref['PROFILE_PBDCLASS_VALUEID'] : ''; if ($this->_rootref['S_PROFILE_PBDGENDER'] && $this->_rootref['PROFILE_PBDGENDER_VALUEID'] > (1)) {  ?> female<?php } ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" title="<?php echo (isset($this->_rootref['PROFILE_PBDCLASS_VALUE'])) ? $this->_rootref['PROFILE_PBDCLASS_VALUE'] : ''; ?>" alt="<?php echo (isset($this->_rootref['PROFILE_PBDCLASS_VALUE'])) ? $this->_rootref['PROFILE_PBDCLASS_VALUE'] : ''; ?>" /></div>							
						<?php } else if ($this->_rootref['PROFILE_PBWSRACE_VALUEID']) {  ?>

						<div class="game-icons-a wildstar-<?php echo (isset($this->_rootref['PROFILE_PBWSRACE_VALUEID'])) ? $this->_rootref['PROFILE_PBWSRACE_VALUEID'] : ''; if ($this->_rootref['S_PROFILE_PBWSGENDER'] && $this->_rootref['PROFILE_PBWSGENDER_VALUEID'] > (1)) {  ?> female<?php } ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" title="<?php echo (isset($this->_rootref['PROFILE_PBWSRACE_VALUE'])) ? $this->_rootref['PROFILE_PBWSRACE_VALUE'] : ''; ?>" alt="<?php echo (isset($this->_rootref['PROFILE_PBWSRACE_VALUE'])) ? $this->_rootref['PROFILE_PBWSRACE_VALUE'] : ''; ?>" /></div>							
						<?php } if ($this->_rootref['PROFILE_PBCLASS_VALUEID']) {  ?>

						<div class="game-icons-b wow-<?php echo (isset($this->_rootref['PROFILE_PBCLASS_VALUEID'])) ? $this->_rootref['PROFILE_PBCLASS_VALUEID'] : ''; ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" title="<?php echo (isset($this->_rootref['PROFILE_PBCLASS_VALUE'])) ? $this->_rootref['PROFILE_PBCLASS_VALUE'] : ''; ?>" alt="<?php echo (isset($this->_rootref['PROFILE_PBCLASS_VALUE'])) ? $this->_rootref['PROFILE_PBCLASS_VALUE'] : ''; ?>" /></div>
						<?php } else if ($this->_rootref['PROFILE_PBDFOLLOWER_VALUEID']) {  ?>

						<div class="game-icons-b diablo-<?php echo (isset($this->_rootref['PROFILE_PBDFOLLOWER_VALUEID'])) ? $this->_rootref['PROFILE_PBDFOLLOWER_VALUEID'] : ''; ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" title="<?php echo (isset($this->_rootref['PROFILE_PBDFOLLOWER_VALUE'])) ? $this->_rootref['PROFILE_PBDFOLLOWER_VALUE'] : ''; ?>" alt="<?php echo (isset($this->_rootref['PROFILE_PBDFOLLOWER_VALUE'])) ? $this->_rootref['PROFILE_PBDFOLLOWER_VALUE'] : ''; ?>" /></div>
						<?php } else if ($this->_rootref['PROFILE_PBWSCLASS_VALUEID']) {  ?>

						<div class="game-icons-b wildstar-<?php echo (isset($this->_rootref['PROFILE_PBWSCLASS_VALUEID'])) ? $this->_rootref['PROFILE_PBWSCLASS_VALUEID'] : ''; ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" title="<?php echo (isset($this->_rootref['PROFILE_PBWSCLASS_VALUE'])) ? $this->_rootref['PROFILE_PBWSCLASS_VALUE'] : ''; ?>" alt="<?php echo (isset($this->_rootref['PROFILE_PBWSCLASS_VALUE'])) ? $this->_rootref['PROFILE_PBWSCLASS_VALUE'] : ''; ?>" /></div>
						<?php } if ($this->_rootref['POSTS_RANK_IMG']) {  ?>

						<div class="game-icons-c" style="background-image: url('<?php echo (isset($this->_rootref['POSTS_RANK_IMG_SRC'])) ? $this->_rootref['POSTS_RANK_IMG_SRC'] : ''; ?>');"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" alt="<?php echo (isset($this->_rootref['POSTS_RANK_TITLE'])) ? $this->_rootref['POSTS_RANK_TITLE'] : ''; ?>" title="<?php echo (isset($this->_rootref['POSTS_RANK_TITLE'])) ? $this->_rootref['POSTS_RANK_TITLE'] : ''; ?>" /></div>
						<?php } else if ($this->_rootref['PROFILE_PBRACE_VALUEID'] && $this->_rootref['S_PROFILE_PBFACTION']) {  ?>

						<div class="game-icons-c wow-<?php echo (isset($this->_rootref['PROFILE_PBFACTION_VALUE'])) ? $this->_rootref['PROFILE_PBFACTION_VALUE'] : ''; ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" /></div>
						<?php } else if ($this->_rootref['PROFILE_PBWSRACE_VALUEID'] && $this->_rootref['S_PROFILE_PBFACTION']) {  ?>

						<div class="game-icons-c wildstar-<?php echo (isset($this->_rootref['PROFILE_PBFACTION_VALUE'])) ? $this->_rootref['PROFILE_PBFACTION_VALUE'] : ''; ?>"><img src = "<?php echo (isset($this->_rootref['T_IMAGESET_PATH'])) ? $this->_rootref['T_IMAGESET_PATH'] : ''; ?>/images/pixel.gif" /></div>
						<?php } ?>
		...
		<?php } else if ($this->_rootref['AVATAR_IMG']) {  ?>

			<?php echo (isset($this->_rootref['AVATAR_IMG'])) ? $this->_rootref['AVATAR_IMG'] : ''; ?>

		<?php } else { ?>

			<div class="game-noavatar"></div>
		<?php } ?>
		...
		<div class="wow-info-frame">
			<dl>
				<dt class="author"><?php echo (isset($this->_rootref['USERNAME_FULL'])) ? $this->_rootref['USERNAME_FULL'] : ''; ?></dt>
				<?php if ($this->_rootref['S_PROFILE_PBGUILD']) {  ?><dd class="guild">&lsaquo; <?php echo (isset($this->_rootref['PROFILE_PBGUILD_VALUE'])) ? $this->_rootref['PROFILE_PBGUILD_VALUE'] : ''; ?> &rsaquo;</dd><?php } if ($this->_rootref['RANK_TITLE'] || $this->_rootref['RANK_IMG']) {  ?><dd class="separator"></dd>
				<dd class="rank" style="display: block; font-weight: bold; font-size: 1.1em;"><?php echo (isset($this->_rootref['RANK_TITLE'])) ? $this->_rootref['RANK_TITLE'] : ''; ?></dd><?php } if ($this->_rootref['POSTS_RANK_TITLE'] != $this->_rootref['RANK_TITLE']) {  ?><dd class="special-rank" style="display: block; font-weight: bold; font-size: 1.1em;""><?php echo (isset($this->_rootref['POSTS_RANK_TITLE'])) ? $this->_rootref['POSTS_RANK_TITLE'] : ''; ?></dd><?php } if ($this->_rootref['S_ONLINE']) {  ?><dd class="separator"></dd><dd class="online"><?php echo ((isset($this->_rootref['L_ONLINE'])) ? $this->_rootref['L_ONLINE'] : ((isset($user->lang['ONLINE'])) ? $user->lang['ONLINE'] : '{ ONLINE }')); ?></dd><?php } ?>
...
<div class="panel bg2">
	...
	<div class="column1">
		...
		<dl class="details">
		<?php if ($this->_rootref['U_EMAIL']) {  ?><dt><?php echo ((isset($this->_rootref['L_EMAIL_ADDRESS'])) ? $this->_rootref['L_EMAIL_ADDRESS'] : ((isset($user->lang['EMAIL_ADDRESS'])) ? $user->lang['EMAIL_ADDRESS'] : '{ EMAIL_ADDRESS }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['U_EMAIL'])) ? $this->_rootref['U_EMAIL'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SEND_EMAIL_USER'])) ? $this->_rootref['L_SEND_EMAIL_USER'] : ((isset($user->lang['SEND_EMAIL_USER'])) ? $user->lang['SEND_EMAIL_USER'] : '{ SEND_EMAIL_USER }')); ?> <?php echo (isset($this->_rootref['USERNAME'])) ? $this->_rootref['USERNAME'] : ''; ?></a></dd><?php } if ($this->_rootref['U_WWW']) {  ?><dt><?php echo ((isset($this->_rootref['L_WEBSITE'])) ? $this->_rootref['L_WEBSITE'] : ((isset($user->lang['WEBSITE'])) ? $user->lang['WEBSITE'] : '{ WEBSITE }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['U_WWW'])) ? $this->_rootref['U_WWW'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VISIT_WEBSITE'])) ? $this->_rootref['L_VISIT_WEBSITE'] : ((isset($user->lang['VISIT_WEBSITE'])) ? $user->lang['VISIT_WEBSITE'] : '{ VISIT_WEBSITE }')); ?>: <?php echo (isset($this->_rootref['U_WWW'])) ? $this->_rootref['U_WWW'] : ''; ?>"><?php echo (isset($this->_rootref['U_WWW'])) ? $this->_rootref['U_WWW'] : ''; ?></a></dd><?php } if ($this->_rootref['U_PM']) {  ?><dt><?php echo ((isset($this->_rootref['L_PM'])) ? $this->_rootref['L_PM'] : ((isset($user->lang['PM'])) ? $user->lang['PM'] : '{ PM }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['U_PM'])) ? $this->_rootref['U_PM'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SEND_PRIVATE_MESSAGE'])) ? $this->_rootref['L_SEND_PRIVATE_MESSAGE'] : ((isset($user->lang['SEND_PRIVATE_MESSAGE'])) ? $user->lang['SEND_PRIVATE_MESSAGE'] : '{ SEND_PRIVATE_MESSAGE }')); ?></a></dd><?php } if ($this->_rootref['U_MSN'] || $this->_rootref['USER_MSN']) {  ?><dt><?php echo ((isset($this->_rootref['L_MSNM'])) ? $this->_rootref['L_MSNM'] : ((isset($user->lang['MSNM'])) ? $user->lang['MSNM'] : '{ MSNM }')); ?>:</dt> <dd><?php if ($this->_rootref['U_MSN']) {  ?><a href="<?php echo (isset($this->_rootref['U_MSN'])) ? $this->_rootref['U_MSN'] : ''; ?>" onclick="popup(this.href, 550, 320); return false;"><?php echo ((isset($this->_rootref['L_SEND_MSNM_MESSAGE'])) ? $this->_rootref['L_SEND_MSNM_MESSAGE'] : ((isset($user->lang['SEND_MSNM_MESSAGE'])) ? $user->lang['SEND_MSNM_MESSAGE'] : '{ SEND_MSNM_MESSAGE }')); ?></a><?php } else { echo (isset($this->_rootref['USER_MSN'])) ? $this->_rootref['USER_MSN'] : ''; } ?></dd><?php } if ($this->_rootref['U_YIM'] || $this->_rootref['USER_YIM']) {  ?><dt><?php echo ((isset($this->_rootref['L_YIM'])) ? $this->_rootref['L_YIM'] : ((isset($user->lang['YIM'])) ? $user->lang['YIM'] : '{ YIM }')); ?>:</dt> <dd><?php if ($this->_rootref['U_YIM']) {  ?><a href="<?php echo (isset($this->_rootref['U_YIM'])) ? $this->_rootref['U_YIM'] : ''; ?>" onclick="popup(this.href, 780, 550); return false;"><?php echo ((isset($this->_rootref['L_SEND_YIM_MESSAGE'])) ? $this->_rootref['L_SEND_YIM_MESSAGE'] : ((isset($user->lang['SEND_YIM_MESSAGE'])) ? $user->lang['SEND_YIM_MESSAGE'] : '{ SEND_YIM_MESSAGE }')); ?></a><?php } else { echo (isset($this->_rootref['USER_YIM'])) ? $this->_rootref['USER_YIM'] : ''; } ?></dd><?php } if ($this->_rootref['U_AIM'] || $this->_rootref['USER_AIM']) {  ?><dt><?php echo ((isset($this->_rootref['L_AIM'])) ? $this->_rootref['L_AIM'] : ((isset($user->lang['AIM'])) ? $user->lang['AIM'] : '{ AIM }')); ?>:</dt> <dd><?php if ($this->_rootref['U_AIM']) {  ?><a href="<?php echo (isset($this->_rootref['U_AIM'])) ? $this->_rootref['U_AIM'] : ''; ?>" onclick="popup(this.href, 550, 320); return false;"><?php echo ((isset($this->_rootref['L_SEND_AIM_MESSAGE'])) ? $this->_rootref['L_SEND_AIM_MESSAGE'] : ((isset($user->lang['SEND_AIM_MESSAGE'])) ? $user->lang['SEND_AIM_MESSAGE'] : '{ SEND_AIM_MESSAGE }')); ?></a><?php } else { echo (isset($this->_rootref['USER_AIM'])) ? $this->_rootref['USER_AIM'] : ''; } ?></dd><?php } if ($this->_rootref['U_ICQ'] || $this->_rootref['USER_ICQ']) {  ?><dt><?php echo ((isset($this->_rootref['L_ICQ'])) ? $this->_rootref['L_ICQ'] : ((isset($user->lang['ICQ'])) ? $user->lang['ICQ'] : '{ ICQ }')); ?>:</dt> <dd><?php if ($this->_rootref['U_ICQ']) {  ?><a href="<?php echo (isset($this->_rootref['U_ICQ'])) ? $this->_rootref['U_ICQ'] : ''; ?>" onclick="popup(this.href, 550, 320); return false;"><?php echo ((isset($this->_rootref['L_SEND_ICQ_MESSAGE'])) ? $this->_rootref['L_SEND_ICQ_MESSAGE'] : ((isset($user->lang['SEND_ICQ_MESSAGE'])) ? $user->lang['SEND_ICQ_MESSAGE'] : '{ SEND_ICQ_MESSAGE }')); ?></a><?php } else { echo (isset($this->_rootref['USER_ICQ'])) ? $this->_rootref['USER_ICQ'] : ''; } ?></dd><?php } if ($this->_rootref['U_JABBER'] && $this->_rootref['S_JABBER_ENABLED']) {  ?><dt><?php echo ((isset($this->_rootref['L_JABBER'])) ? $this->_rootref['L_JABBER'] : ((isset($user->lang['JABBER'])) ? $user->lang['JABBER'] : '{ JABBER }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['U_JABBER'])) ? $this->_rootref['U_JABBER'] : ''; ?>" onclick="popup(this.href, 550, 320); return false;"><?php echo ((isset($this->_rootref['L_SEND_JABBER_MESSAGE'])) ? $this->_rootref['L_SEND_JABBER_MESSAGE'] : ((isset($user->lang['SEND_JABBER_MESSAGE'])) ? $user->lang['SEND_JABBER_MESSAGE'] : '{ SEND_JABBER_MESSAGE }')); ?></a></dd><?php } else if ($this->_rootref['USER_JABBER']) {  ?><dt><?php echo ((isset($this->_rootref['L_JABBER'])) ? $this->_rootref['L_JABBER'] : ((isset($user->lang['JABBER'])) ? $user->lang['JABBER'] : '{ JABBER }')); ?>:</dt> <dd><?php echo (isset($this->_rootref['USER_JABBER'])) ? $this->_rootref['USER_JABBER'] : ''; ?></dd><?php } if ($this->_rootref['USER_BEBO_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_BEBO'])) ? $this->_rootref['L_BEBO'] : ((isset($user->lang['BEBO'])) ? $user->lang['BEBO'] : '{ BEBO }')); ?>:</dt> <dd><a href="http://www.bebo.com/<?php echo (isset($this->_rootref['USER_BEBO_SN'])) ? $this->_rootref['USER_BEBO_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_BEBO'])) ? $this->_rootref['L_VIEW_BEBO'] : ((isset($user->lang['VIEW_BEBO'])) ? $user->lang['VIEW_BEBO'] : '{ VIEW_BEBO }')); ?>: <?php echo (isset($this->_rootref['USER_BEBO_SN'])) ? $this->_rootref['USER_BEBO_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_BEBO'])) ? $this->_rootref['L_VIEW_BEBO'] : ((isset($user->lang['VIEW_BEBO'])) ? $user->lang['VIEW_BEBO'] : '{ VIEW_BEBO }')); ?></a></dd><?php } if ($this->_rootref['USER_BLOGGER_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_BLOGGER'])) ? $this->_rootref['L_BLOGGER'] : ((isset($user->lang['BLOGGER'])) ? $user->lang['BLOGGER'] : '{ BLOGGER }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['USER_BLOGGER_SN'])) ? $this->_rootref['USER_BLOGGER_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_BLOGGER'])) ? $this->_rootref['L_VIEW_BLOGGER'] : ((isset($user->lang['VIEW_BLOGGER'])) ? $user->lang['VIEW_BLOGGER'] : '{ VIEW_BLOGGER }')); ?>: <?php echo (isset($this->_rootref['USER_BLOGGER_SN'])) ? $this->_rootref['USER_BLOGGER_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_BLOGGER'])) ? $this->_rootref['L_VIEW_BLOGGER'] : ((isset($user->lang['VIEW_BLOGGER'])) ? $user->lang['VIEW_BLOGGER'] : '{ VIEW_BLOGGER }')); ?></a></dd><?php } if ($this->_rootref['USER_FACEBOOK_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_FACEBOOK'])) ? $this->_rootref['L_FACEBOOK'] : ((isset($user->lang['FACEBOOK'])) ? $user->lang['FACEBOOK'] : '{ FACEBOOK }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['USER_FACEBOOK_SN'])) ? $this->_rootref['USER_FACEBOOK_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_FACEBOOK'])) ? $this->_rootref['L_VIEW_FACEBOOK'] : ((isset($user->lang['VIEW_FACEBOOK'])) ? $user->lang['VIEW_FACEBOOK'] : '{ VIEW_FACEBOOK }')); ?>: <?php echo (isset($this->_rootref['USER_FACEBOOK_SN'])) ? $this->_rootref['USER_FACEBOOK_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_FACEBOOK'])) ? $this->_rootref['L_VIEW_FACEBOOK'] : ((isset($user->lang['VIEW_FACEBOOK'])) ? $user->lang['VIEW_FACEBOOK'] : '{ VIEW_FACEBOOK }')); ?></a></dd><?php } if ($this->_rootref['USER_GOODREADS_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_GOODREADS'])) ? $this->_rootref['L_GOODREADS'] : ((isset($user->lang['GOODREADS'])) ? $user->lang['GOODREADS'] : '{ GOODREADS }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['USER_GOODREADS_SN'])) ? $this->_rootref['USER_GOODREADS_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_GOODREADS'])) ? $this->_rootref['L_VIEW_GOODREADS'] : ((isset($user->lang['VIEW_GOODREADS'])) ? $user->lang['VIEW_GOODREADS'] : '{ VIEW_GOODREADS }')); ?>: <?php echo (isset($this->_rootref['USER_GOODREADS_SN'])) ? $this->_rootref['USER_GOODREADS_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_GOODREADS'])) ? $this->_rootref['L_VIEW_GOODREADS'] : ((isset($user->lang['VIEW_GOODREADS'])) ? $user->lang['VIEW_GOODREADS'] : '{ VIEW_GOODREADS }')); ?></a></dd><?php } if ($this->_rootref['USER_LINKEDIN_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_LINKEDIN'])) ? $this->_rootref['L_LINKEDIN'] : ((isset($user->lang['LINKEDIN'])) ? $user->lang['LINKEDIN'] : '{ LINKEDIN }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['USER_LINKEDIN_SN'])) ? $this->_rootref['USER_LINKEDIN_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_LINKEDIN'])) ? $this->_rootref['L_VIEW_LINKEDIN'] : ((isset($user->lang['VIEW_LINKEDIN'])) ? $user->lang['VIEW_LINKEDIN'] : '{ VIEW_LINKEDIN }')); ?>: <?php echo (isset($this->_rootref['USER_LINKEDIN_SN'])) ? $this->_rootref['USER_LINKEDIN_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_LINKEDIN'])) ? $this->_rootref['L_VIEW_LINKEDIN'] : ((isset($user->lang['VIEW_LINKEDIN'])) ? $user->lang['VIEW_LINKEDIN'] : '{ VIEW_LINKEDIN }')); ?></a></dd><?php } if ($this->_rootref['USER_MYSPACE_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_MYSPACE'])) ? $this->_rootref['L_MYSPACE'] : ((isset($user->lang['MYSPACE'])) ? $user->lang['MYSPACE'] : '{ MYSPACE }')); ?>:</dt> <dd><a href="http://www.myspace.com/<?php echo (isset($this->_rootref['USER_MYSPACE_SN'])) ? $this->_rootref['USER_MYSPACE_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_MYSPACE'])) ? $this->_rootref['L_VIEW_MYSPACE'] : ((isset($user->lang['VIEW_MYSPACE'])) ? $user->lang['VIEW_MYSPACE'] : '{ VIEW_MYSPACE }')); ?>: <?php echo (isset($this->_rootref['USER_MYSPACE_SN'])) ? $this->_rootref['USER_MYSPACE_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_MYSPACE'])) ? $this->_rootref['L_VIEW_MYSPACE'] : ((isset($user->lang['VIEW_MYSPACE'])) ? $user->lang['VIEW_MYSPACE'] : '{ VIEW_MYSPACE }')); ?></a></dd><?php } if ($this->_rootref['USER_NETLOG_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_NETLOG'])) ? $this->_rootref['L_NETLOG'] : ((isset($user->lang['NETLOG'])) ? $user->lang['NETLOG'] : '{ NETLOG }')); ?>:</dt> <dd><a href="<?php echo (isset($this->_rootref['USER_NETLOG_SN'])) ? $this->_rootref['USER_NETLOG_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_NETLOG'])) ? $this->_rootref['L_VIEW_NETLOG'] : ((isset($user->lang['VIEW_NETLOG'])) ? $user->lang['VIEW_NETLOG'] : '{ VIEW_NETLOG }')); ?>: <?php echo (isset($this->_rootref['USER_NETLOG_SN'])) ? $this->_rootref['USER_NETLOG_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_NETLOG'])) ? $this->_rootref['L_VIEW_NETLOG'] : ((isset($user->lang['VIEW_NETLOG'])) ? $user->lang['VIEW_NETLOG'] : '{ VIEW_NETLOG }')); ?></a></dd><?php } if ($this->_rootref['USER_TWITTER_SN']) {  ?><dt><?php echo ((isset($this->_rootref['L_TWITTER'])) ? $this->_rootref['L_TWITTER'] : ((isset($user->lang['TWITTER'])) ? $user->lang['TWITTER'] : '{ TWITTER }')); ?>:</dt> <dd><a href="http://www.twitter.com/<?php echo (isset($this->_rootref['USER_TWITTER_SN'])) ? $this->_rootref['USER_TWITTER_SN'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_VIEW_TWITTER'])) ? $this->_rootref['L_VIEW_TWITTER'] : ((isset($user->lang['VIEW_TWITTER'])) ? $user->lang['VIEW_TWITTER'] : '{ VIEW_TWITTER }')); ?>: <?php echo (isset($this->_rootref['USER_TWITTER_SN'])) ? $this->_rootref['USER_TWITTER_SN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_VIEW_TWITTER'])) ? $this->_rootref['L_VIEW_TWITTER'] : ((isset($user->lang['VIEW_TWITTER'])) ? $user->lang['VIEW_TWITTER'] : '{ VIEW_TWITTER }')); ?></a></dd><?php } if ($this->_rootref['S_PROFILE_FIELD1']) {  ?><!-- NOTE: Use a construct like this to include admin defined profile fields. Replace FIELD1 with the name of your field. -->
			<dt><?php echo (isset($this->_rootref['PROFILE_FIELD1_NAME'])) ? $this->_rootref['PROFILE_FIELD1_NAME'] : ''; ?>:</dt> <dd><?php echo (isset($this->_rootref['PROFILE_FIELD1_VALUE'])) ? $this->_rootref['PROFILE_FIELD1_VALUE'] : ''; ?></dd>
		<?php } ?>
