	...
	<ul class="topiclist bg1">
		<li>
			<dl>
				...
				<table width="100%">
				<tr class="menutitle">
					<?php if (sizeof($this->_tpldata['latest_announcements'])) {  ?><td><strong><?php echo ((isset($this->_rootref['L_PORTAL_RECENT_ANN'])) ? $this->_rootref['L_PORTAL_RECENT_ANN'] : ((isset($user->lang['PORTAL_RECENT_ANN'])) ? $user->lang['PORTAL_RECENT_ANN'] : '{ PORTAL_RECENT_ANN }')); ?></strong></td><?php } if (sizeof($this->_tpldata['latest_hot_topics'])) {  ?><td><strong><?php echo ((isset($this->_rootref['L_PORTAL_RECENT_HOT_TOPIC'])) ? $this->_rootref['L_PORTAL_RECENT_HOT_TOPIC'] : ((isset($user->lang['PORTAL_RECENT_HOT_TOPIC'])) ? $user->lang['PORTAL_RECENT_HOT_TOPIC'] : '{ PORTAL_RECENT_HOT_TOPIC }')); ?></strong></td><?php } if (sizeof($this->_tpldata['latest_topics'])) {  ?><td><strong><?php echo ((isset($this->_rootref['L_PORTAL_RECENT_TOPIC'])) ? $this->_rootref['L_PORTAL_RECENT_TOPIC'] : ((isset($user->lang['PORTAL_RECENT_TOPIC'])) ? $user->lang['PORTAL_RECENT_TOPIC'] : '{ PORTAL_RECENT_TOPIC }')); ?></strong></td><?php } ?>
				...
				<tr>
					...
					<td class="row1" style="width: 33%;" valign="top">
						...
						<?php $_latest_announcements_count = (isset($this->_tpldata['latest_announcements'])) ? sizeof($this->_tpldata['latest_announcements']) : 0;if ($_latest_announcements_count) {for ($_latest_announcements_i = 0; $_latest_announcements_i < $_latest_announcements_count; ++$_latest_announcements_i){$_latest_announcements_val = &$this->_tpldata['latest_announcements'][$_latest_announcements_i]; ?>
									...
									<a href="<?php echo $_latest_announcements_val['U_VIEW_TOPIC']; ?>" title="<?php echo $_latest_announcements_val['FULL_TITLE']; ?>"><?php echo $_latest_announcements_val['TITLE']; ?></a>
						<?php }} ?>
					...
					<td class="row1" style="width: 33%;" valign="top">
						...
						<?php $_latest_hot_topics_count = (isset($this->_tpldata['latest_hot_topics'])) ? sizeof($this->_tpldata['latest_hot_topics']) : 0;if ($_latest_hot_topics_count) {for ($_latest_hot_topics_i = 0; $_latest_hot_topics_i < $_latest_hot_topics_count; ++$_latest_hot_topics_i){$_latest_hot_topics_val = &$this->_tpldata['latest_hot_topics'][$_latest_hot_topics_i]; ?>
							...
							<a href="<?php echo $_latest_hot_topics_val['U_VIEW_TOPIC']; ?>" title="<?php echo $_latest_hot_topics_val['FULL_TITLE']; ?>"><?php echo $_latest_hot_topics_val['TITLE']; ?></a>
						<?php }} ?>
					...
					<td class="row1" style="width: 33%;" valign="top">
						...
						<?php $_latest_topics_count = (isset($this->_tpldata['latest_topics'])) ? sizeof($this->_tpldata['latest_topics']) : 0;if ($_latest_topics_count) {for ($_latest_topics_i = 0; $_latest_topics_i < $_latest_topics_count; ++$_latest_topics_i){$_latest_topics_val = &$this->_tpldata['latest_topics'][$_latest_topics_i]; ?>
							...
							<a href="<?php echo $_latest_topics_val['U_VIEW_TOPIC']; ?>" title="<?php echo $_latest_topics_val['FULL_TITLE']; ?>"><?php echo $_latest_topics_val['TITLE']; ?></a>
						<?php }} ?>
