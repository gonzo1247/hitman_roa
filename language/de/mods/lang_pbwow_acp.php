...
$lang = array_merge($lang, array(
	...
	'PBWOW_CHARSDB_GOOD'				=> 'PBWoW 2 characters table found (%s)',
	'PBWOW_CHARSDB_BAD'					=> 'No PBWoW characters table found. Make sure that the table (%s) exists in your phpBB database.',
	'PBWOW_CHARSDB_BAD_EXPLAIN'			=> 'Run the required PBWoW 2 Battle.net Characters installation script included in the MOD package. This will create and populate the appropriate database table.',
	...
	'ACP_PBWOW_CONFIG_TITLE_EXPLAIN'	=> 'Here you can choose some options to customize your PBWoW 2 installation.',
	...
	'PBWOW_LOGO_ENABLE_EXPLAIN'			=> 'Using this will enable your own custom logo for all installed PBWoW 2 styles, except the PBWoW 2 master style.',
	...
	'PBWOW_TOPBAR_FIXED_EXPLAIN'		=> 'Fixing the top header-bar to the top of the screen will keep it visible and locked in place, even when scrolling. This only applies to devices with a minimum width of 670px (smaller devices will revert back to scrolling).',
	...
	'ACP_PBWOW_NAVMENU'					=> 'Breadcrumb Navigation Menus',
	...
	'PBWOW_VIDEOBG_ALLPAGES_EXPLAIN'	=> 'By default, PBWoW 2 only loads the video backgrounds (if available) on <u>index.php</u> pages. You can enable them for all pages, but this may affect the browsing speed of your visitors (but in general not your server bandwidth, because they are cached locally). [only applies if video is enabled]',
	...
	'ACP_PBWOW_BNETCHARS'				=> 'Battle.net Character Information',
	'PBWOW_BNETCHARS_ENABLE'			=> 'Enable Battle.net API character information',
	'PBWOW_BNETCHARS_ENABLE_EXPLAIN'	=> 'Enable this feature to use the Battle.net API to retrieve character information (when available), for use in user profiles. Visit PBWoW.com for more information on this feature.',
